...
<?php 
    ...
    $query = "SELECT * FROM menutype WHERE t_id!=$t_id";//ไม่แสดงข้อมูลเก่าในรายการ select
...
<form action="db_form_editMenu.php" method="POST" class="form-horizontal" enctype="multipart/form-data">
    ...
    <label for="exampleInputEmail1">Name</label>
        <input type="text" name="m_name" class="form-control" id="exampleInputEmail1" placeholder="name" value="<?php echo $row['m_name']; ?>" required> 
    </div>
    
    <div class="form-group">
    <label for="exampleInputPassword1">Price</label>
        <input type="number" name="m_price" class="form-control" id="exampleInputPassword1" placeholder="Price" value="<?php echo $row['m_price']; ?>" required>
    </div>
    ...
    Old Image
    <br><img src="mimg/<?php echo $row['m_img']; ?>" width="100px"><br><br><br><br><br> 
    </label>
        <input type="file" name="m_img" accept="image/*">
    </div>
    <input type="hidden" name="m_img2" value="<?php echo $row['m_img']; //ส่งค่าภาพเก่า?>">
